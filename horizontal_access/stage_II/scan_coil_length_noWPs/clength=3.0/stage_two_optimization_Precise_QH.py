...
LENGTH_WEIGHT = 0.0156434465 * 100
coil_length = 3.0
...
summscs = J_summscs.J()
LINKNUM = linkNum.J()
logprint(f'Total length={jl:.2E}, ccdist min={ccdist:.2E}, csdist min={csdist:.2E}, max maxc={np.max(maxc):.2E}, summscs={summscs:.2E}, jln={LINKNUM:.2E}\n')
